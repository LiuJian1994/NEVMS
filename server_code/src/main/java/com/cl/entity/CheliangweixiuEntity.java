...
public class CheliangweixiuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public CheliangweixiuEntity() {
		
	}
	
	public CheliangweixiuEntity(T t) {
		try {
	 ...
	 * 设置：维修部位
	 */
	public void setWeixiubuwei(String weixiubuwei) {
		this.weixiubuwei = weixiubuwei;
	}
	/**
	 * 获取：维修部位
	 */
	public String getWeixiubuwei() {
		return weixiubuwei;
	}
	/**
	 * 设置：维修时间
