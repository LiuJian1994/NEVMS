...
<div class="header-top">
    ...
    <div class="user" v-if="showUser">
        ...
        <el-dropdown v-else >
            <div class="user-avatar">
                ...
                <i v-if="false" class="el-icon-caret-bottom" style="cursor: pointer;position: absolute;right: -20px;top: 25px;font-size: 12px;"></i>
            </div>
    ...
    <div class="userName" v-if="showUser && userInfo.value">
        {{toolUtil.storageGet("username")}}
    </div>
</div>
    `,
    props:{
